  ...
  return (
    <div 
      ...
      className={`
        ...
        ${small ? 'h-16 w-12 text-lg rounded' : 'h-24 w-16 text-2xl sm:h-32 sm:w-20 sm:text-3xl rounded-2xl'}
      ...
      `}
    >
      <div className={`absolute inset-0 ${small ? 'rounded-lg' : 'rounded-2xl'} bg-[linear-gradient(135deg,rgba(255,255,255,0.35),rgba(255,255,255,0.05)_30%,rgba(0,0,0,0.15)_100%)] mix-blend-soft-light`} />
